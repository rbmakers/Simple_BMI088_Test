...
// Custom Flight Control Board Defaults
...
class BMI088 {
public:
    // Constructor accepts standard Wire instances to allow dynamic RP2354A pin configurations
    BMI088(TwoWire& wireInstance, uint8_t acc_addr, uint8_t gyro_addr);
...
private:
    ...
    TwoWire* _wire; // Pointer to selected hardware I2C peripheral block
    float accRange;
    float gyroRange;
    uint8_t devAddrAcc;
    uint8_t devAddrGyro;
